 ...
 *
 * Backed by an EVM wallet on Ethereum Sepolia — dorr settles there and margins
 * in mUSD (an ERC-20), so the acting identity has to be an EVM account.
 *
...
export function useDorrWallet() {
  ...
  return {
    ...
    /** The viem WalletClient — used for mUSD approve/deposit and signing. */
    ...
    switchToSepolia: evm.switchToSepolia,
  };
}
