...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      proveLiquidationBreach: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`proveLiquidationBreach: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const threshold_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveLiquidationBreach',
                                     'argument 1 (as invoked from Typescript)',
                                     'zkperps-liquidation.compact line 23 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._proveLiquidationBreach_0(context,
                                                        partialProofData,
                                                        threshold_0);
    ...
    this.impureCircuits = {
      proveLiquidationBreach: this.circuits.proveLiquidationBreach
    };
  ...
  initialState(...args_0) {
    ...
    if (!(commitment_0.buffer instanceof ArrayBuffer && commitment_0.BYTES_PER_ELEMENT === 1 && commitment_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'zkperps-liquidation.compact line 17 char 1',
                                 'Bytes<32>',
                                 commitment_0)
    }
    ...
    state_0.setOperation('proveLiquidationBreach', new __compactRuntime.ContractOperation());
  ...
  _marginWitness_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'object' && typeof(result_0.is_some) === 'boolean' && result_0.value.buffer instanceof ArrayBuffer && result_0.value.BYTES_PER_ELEMENT === 1 && result_0.value.length === 32)) {
      __compactRuntime.typeError('marginWitness',
                                 'return value',
                                 'zkperps-liquidation.compact line 11 char 1',
  ...
  _proveLiquidationBreach_0(context, partialProofData, threshold_0) {
