...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      proveAndFinalizeMatch: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`proveAndFinalizeMatch: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const matchDigest_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveAndFinalizeMatch',
                                     'argument 1 (as invoked from Typescript)',
                                     'zkperps-matching.compact line 28 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._proveAndFinalizeMatch_0(context,
                                                       partialProofData,
                                                       matchDigest_0);
    ...
    this.impureCircuits = {
      proveAndFinalizeMatch: this.circuits.proveAndFinalizeMatch
    };
  ...
  initialState(...args_0) {
    ...
    if (!(bid_0.buffer instanceof ArrayBuffer && bid_0.BYTES_PER_ELEMENT === 1 && bid_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'zkperps-matching.compact line 21 char 1',
                                 'Bytes<32>',
                                 bid_0)
    }
    ...
    state_0.setOperation('proveAndFinalizeMatch', new __compactRuntime.ContractOperation());
  ...
  _bidPreimage_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'object' && typeof(result_0.is_some) === 'boolean' && result_0.value.buffer instanceof ArrayBuffer && result_0.value.BYTES_PER_ELEMENT === 1 && result_0.value.length === 32)) {
      __compactRuntime.typeError('bidPreimage',
                                 'return value',
                                 'zkperps-matching.compact line 14 char 1',
  ...
  _askPreimage_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'object' && typeof(result_0.is_some) === 'boolean' && result_0.value.buffer instanceof ArrayBuffer && result_0.value.BYTES_PER_ELEMENT === 1 && result_0.value.length === 32)) {
      __compactRuntime.typeError('askPreimage',
                                 'return value',
                                 'zkperps-matching.compact line 15 char 1',
                                 'struct Maybe<is_some: Boolean, value: Bytes<32>>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _proveAndFinalizeMatch_0(context, partialProofData, matchDigest_0) {
