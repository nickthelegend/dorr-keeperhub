...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      proveSettlementTransition: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`proveSettlementTransition: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const nextDigest_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveSettlementTransition',
                                     'argument 1 (as invoked from Typescript)',
                                     'zkperps-settlement.compact line 19 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._proveSettlementTransition_0(context,
                                                           partialProofData,
                                                           nextDigest_0);
    ...
    this.impureCircuits = {
      proveSettlementTransition: this.circuits.proveSettlementTransition
    };
  ...
  initialState(...args_0) {
    ...
    if (!(initialDigest_0.buffer instanceof ArrayBuffer && initialDigest_0.BYTES_PER_ELEMENT === 1 && initialDigest_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'zkperps-settlement.compact line 14 char 1',
                                 'Bytes<32>',
                                 initialDigest_0)
    }
    ...
    state_0.setOperation('proveSettlementTransition', new __compactRuntime.ContractOperation());
  ...
  _transitionPayload_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'object' && typeof(result_0.is_some) === 'boolean' && result_0.value.buffer instanceof ArrayBuffer && result_0.value.BYTES_PER_ELEMENT === 1 && result_0.value.length === 32)) {
      __compactRuntime.typeError('transitionPayload',
                                 'return value',
                                 'zkperps-settlement.compact line 8 char 1',
  ...
  _proveSettlementTransition_0(context, partialProofData, nextDigest_0) {
